"""Training loop for radar-camera JEPA model."""
...
class Trainer:
    """Trains and evaluates the JEPA radar-camera fusion model.
    ...
    Args:
        ...
        config: Namespace / dict with training hyper-parameters.
    """
    ...
    def train_one_epoch(self, epoch: int = 0) -> dict[str, float]:
        ...
        for step, batch in enumerate(self.train_loader, 1):
            ...
            with torch.amp.autocast("cuda", enabled=self.amp_enabled):
                ...
                losses = combined_loss(outputs, batch, self.loss_weights)
